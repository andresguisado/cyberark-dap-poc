...
docker-compose exec jenkins ansible-galaxy collection install /tmp/cyberark-conjur-1.0.7.tar.gz -p /root/.ansible/collections
docker-compose exec jenkins ansible-galaxy collection install /tmp/cyberark-conjur-1.0.7.tar.gz -p $JENKINS_HOME/.ansible/collections
